function printWorkOrderAction(request, response) {
    ...
    var workNo = work_Order.getFieldValue('tranid');
    nlapiLogExecution('DEBUG', 'workNo', workNo);
   ...
   var subsidiary = work_Order.getFieldValue('subsidiary');
    ...
    //     + "                                            <tr> "
    //     + "                                                <td width=\"50%\" border-right=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\"> "
    //     + "                                                    <table width=\"100%\" padding=\" 0px\"> "
    //     + "                                                        <tr> "
    //     + "                                                            <td width=\"28%\" border-right=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\"> "
    //     + "                                                                <b>Assembly Item</b> "
    //     + "                                                            </td> "
    //     + "                                                            <td width=\"2%\"  border-bottom=\"0.5px solid #000000\">&nbsp;&nbsp;</td> ";
   
    //     template +=
    //         "                                                            <td width=\"70%\"  border-bottom=\"0.5px solid #000000\"> "
    //         + "                                                                <p class=\"alignL\"> "
    //         + "                                                                    <b>" +relaceCharector(assembly) + "</b> "
    //         + "                                                                </p> "
    //         + "                                                            </td> ";
    ...
    //     + "                                                </p> "
    //     + "                                            </td> "
    //     + "                                            <td width=\"1%\" border-bottom=\"0.5px solid #000000\"> "
    //     + "                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
    //     + "                                            </td> "

    //     + "                                                <td align=\"left\" width=\"64%\" border-bottom=\"0.5px solid #000000\"> "
    //     + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " + relaceCharector(billMaterial)+ " </p> "
    ...
    //     + "                                                                </p> "
    //     + "                                                            </td> "
    //     + "                                                            <td  border-bottom=\"0.5px solid #000000\">&nbsp;&nbsp;</td> "
    //     + "                                                            <td border-bottom=\"0.5px solid #000000\"> " + relaceCharector(revision )+ "</td> "
    ...
    //     + "                                                            </td> "
    //     + "                                                            <td >&nbsp;&nbsp;</td> "
    //     + "                                                            <td>" +relaceCharector( memo) + "</td> "
    //     + "                                                        </tr> ";

                                                 
        nlapiLogExecution('DEBUG', 'workNo', workNo);
        var newWorkNo = removeNull(workNo)
        nlapiLogExecution('DEBUG', 'newWorkNo', newWorkNo);
    ...
    //     "                                                    </table> "
        ...
        // + "                                                        <tr> "
        // + "                                                            <td colspan=\"1\" align=\"left\" width=\"30%\" height=\"30%\" border-bottom=\"0.5px solid #000000\" border-top=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\"> "
        // + "                                                                <p align=\"left\"> "
        // + "                                                                    <b>W/O No</b> "
        // + "                                                                </p> "
        // + "                                                            </td> "
        // + "                                                            <td width=\"1%\" border-bottom=\"0.5px solid #000000\" border-top=\"0.5px solid #000000\"> "
        // + "                                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
        // + "                                                            </td> "
        
        // + "                                                            <td align=\"left\" width=\"69%\" border-bottom=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\" border-top=\"0.5px solid #000000\"> "+removeNull(workNo)
        // // + "                                                                <b></b> "
        // + "                                                            </td> "
        // + "                                                        </tr> "
        ...
        // + "                                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
        // + "                                                            </td> "
        // + "                                                            <td align=\"left\" width=\"69%\" border-right=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\">" + workDate +  "</td> "
        // + "                                                        </tr> "
        ...
        // + "                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
        // + "                                            </td> "
        // + "                                                <td align=\"left\" width=\"69%\" border-bottom=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\" > "
        ...
        // + "                                        </tr> "
        // + "                                        <tr> "
        // + "                                            <td align=\"left\" width=\"30%\" border-right=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\"> "
        // + "                                                <p align=\"left\"> "
        // + "                                                    <b>Location</b> "
        // + "                                                </p> "
        // + "                                            </td> "
        ...
        // + "                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
        // + "                                            </td> "
        // + "                                                <td align=\"left\" width=\"69%\" border-right=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\"> "
        // + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " +relaceCharector( location) + " </p>"
        // + "                                                </td> "
        ...
        + "                                                </p> "
        + "                                            </td> "
        + "                                            <td width=\"2%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                <b>&nbsp;&nbsp;&nbsp;&nbsp;</b> "
        + "                                            </td> "
        + "                                                <td align=\"left\" width=\"33%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " +relaceCharector(assembly) + " </p>"
        + "                                                </td> "
        +"                                              <td align=\"left\" width=\"15%\" border-left=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\"> "
        + "                                                <p align=\"left\"> "
        + "                                                    <b>W/O No</b> "
        + "                                                </p> "
        + "                                            </td> "
        ...
        + "                                            </td> "
        + "                                                <td align=\"left\" width=\"33%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " +removeNull(workNo)+ " </p>"
        + "                                                </td> "
        ...
        + "                                            </td> "
        + "                                                <td align=\"left\" width=\"33%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " + workDate + " </p>"
        + "                                                </td> "
        ...
        + "                                            </td> "
        + "                                                <td align=\"left\" width=\"33%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " + relaceCharector(revision )+ " </p>"
        + "                                                </td> "
        +"                                              <td align=\"left\" width=\"15%\" border-left=\"0.5px solid #000000\" border-bottom=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\"> "
        + "                                                <p align=\"left\"> "
        + "                                                    <b>Quantity</b> "
        ...
        + "                                            </td> "
        + "                                                <td align=\"left\" width=\"33%\"  border-bottom=\"0.5px solid #000000\"> "
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " + quantity + " </p>"
        + "                                                </td> "

        + "                                        </tr> "
        + "                                        <tr> "
        + "                                            <td align=\"left\" width=\"15%\" border-right=\"0.5px solid #000000\"> "
        + "                                                <p align=\"left\"> "
        + "                                                    <b>Memo</b> "
        + "                                                </p> "
        + "                                            </td> "
        ...
        + "                                                    <p align=\"left\" style=\"text-decoration:none;\"> " +relaceCharector( memo) + " </p>"
        + "                                                </td> "
        +"                                              <td align=\"left\" width=\"15%\" border-left=\"0.5px solid #000000\" border-right=\"0.5px solid #000000\"> "
        + "                                                <p align=\"left\"> "
        + "                                                    <b>Location</b> "
        + "                                                </p> "
        + "                                            </td> "
    ...
    for (var i = 1; i <= count; i++) {
        ...
        nlapiLogExecution('DEBUG', 'unit11111111', unit);
        ...
        template +=
            ...
            + "                                                        <p class=\"alignL\">" +relaceCharector( item) + "<br /> "
            + "" + relaceCharector(description) + "</p> "
            + "                                                    </td> "
            + "                                                    <td class=\"td_top_line td_right_line\" align=\"center\"> "
            + "                                                        <p class=\"alignC\">" + relaceCharector(quantity) + "</p> "
            + "                                                    </td> "

            + "                                                    <td class=\"td_top_line td_right_line\" align=\"center\"> "

            + "                                                        <p class=\"alignC\">" +relaceCharector (unit) + "</p> "
            + "                                                    </td> "
            + " "

            + "                                                    <td class=\"td_top_line td_right_line\" align=\"center\"> ";
            nlapiLogExecution('DEBUG', 'batchno---------------------');
