...
define(['N/render', 'N/search','N/file','N/log'], function(render, search,file,log) {
    function onRequest(options) {
        ...
        var rectype="customrecord_friends";
        var col=[];
        var fil=[];
        ...
        col.push(search.createColumn({
            name:'custrecord_friends_phone_number',
       ...
       log.debug("results",results)
        ...
        {
             blogEntry={
               id:results[i].getValue('custrecord_friends_name'),
               name:results[i].getValue('custrecord_friends_phone_number')
            }
       ...
       var templateFile=file.load('Templates/exampleName.html');
