function printNewLH(request, response) {
    ...
    var purchRec = nlapiLoadRecord('Invoice', 10530);
    ...
    template += '	<td style="margin-top:30px;" class="addressheader" colspan="3"><b>${record.billaddress@label}</b></td>';
    template += '	<td style="margin-top:30px;" class="addressheader" colspan="3"><b>${record.shipaddress@label}</b></td>';
